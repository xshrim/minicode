...
var registriesResource = schema.GroupVersionResource{Group: "management.cattle.io", Version: "v1alpha1", Resource: "registries"}

var registriesKind = schema.GroupVersionKind{Group: "management.cattle.io", Version: "v1alpha1", Kind: "Registry"}
...
func (c *FakeRegistries) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(registriesResource, name), &v1alpha1.Registry{})
	return err
}
