...
import (
	...
	"github.com/rancher/registry-controller/pkg/generated/clientset/versioned/scheme"
...
// ManagementV1alpha1Client is used to interact with features provided by the management.cattle.io group.
type ManagementV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ManagementV1alpha1Client) Registries() RegistryInterface {
