...
extract_backup(){
    ...
    sudo chown 999:999 -R harbor/db
}
...
restore_database() {
    ...
    $DOCKER_CMD cp harbor/db harbor-db:/home/postgres/
    $DOCKER_CMD exec harbor-db sh -c 'psql -U postgres registry < /home/postgres/db/registry.bak'
    $DOCKER_CMD exec harbor-db sh -c 'psql -U postgres postgres < /home/postgres/db/postgres.bak'
    $DOCKER_CMD exec harbor-db sh -c 'psql -U postgres notarysigner < /home/postgres/db/notarysigner.bak'
    $DOCKER_CMD exec harbor-db sh -c 'psql -U postgres notaryserver < /home/postgres/db/notaryserver.bak'
}
